...
import { submitHackedReport, confirmUpdatesOptIn, uploadEvidence } from "./actions";
  ...
  return (
    <div className="flex items-center gap-2">
      <select
        ...
        defaultValue=""
        onChange={(e) => {
          if (e.target.value) onChoose(e.target.value as AccountCompromiseSubCategoryCode);
        }}
      >
        <option value="" disabled>
          {t("facts.choosePrompt")}
        </option>
        {ACCOUNT_COMPROMISE_SUBCATEGORIES.map((s) => (
